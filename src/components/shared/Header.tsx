                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-shrink-0">
                    {agentConfig.agentPhoto ? (
                      ...
                      <div className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center border-2 border-white/30">
                  ...
                  <div className="text-left">
                    <p className="text-lg font-bold text-white mb-1">{agentName}</p>
